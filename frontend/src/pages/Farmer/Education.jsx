...
export default function Education(){
  ...
  const submit = async (e) => {
    ...
    try{
      ...
      await createProblem({ sector:"education", title, description:extended, location, priority });
      setTitle(""); setDesc("");
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Navbar title="Education - Farmer" />
      <div className="max-w-5xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white border rounded-xl shadow-sm p-5">
          <h3 className="text-lg font-semibold mb-2">Report Education Problem</h3>
          ...
          <form onSubmit={submit} className="space-y-3">
            <div>
              ...
              <input className={`w-full border rounded px-3 py-2 ${formErrors.title? 'border-red-400':''}`} placeholder="e.g., No Teachers" value={title} onChange={e=>setTitle(e.target.value)} />
